...
class Main {
  ...
  constructor(obj) {
    if (obj != null) {
      ...
      if (obj.hasOwnProperty('temp_min')) {
        this.temp_min = obj['temp_min'];
      }
      if (obj.hasOwnProperty('temp_max')) {
        this.temp_max = obj['temp_max'];
      }
      if (obj.hasOwnProperty('sea_level')) {
        this.sea_level = obj['sea_level'];
      }
      if (obj.hasOwnProperty('grnd_level')) {
        this.grnd_level = obj['grnd_level'];
      }
    }
  }
}
...
class Rain {
  ...
  constructor(obj) {
    if (obj != null) {
      if (obj.hasOwnProperty('3h')) {
        this.threehour = obj['3h'];
      } // converted '3h' to 'threehour', a valid JS variable name
    }
  }
}
...
class Sys {
  ...
  constructor(obj) {
    if (obj != null) {
      ...
      if (obj.hasOwnProperty('sunrise')) {
        this.sunrise = obj['sunrise'] * 1000;
      } // convert to ms to be compatible with Date lib
      if (obj.hasOwnProperty('sunset')) {
        this.sunset = obj['sunset'] * 1000;
      } // convert to ms to be compatible with Date lib
    }
  }
}
...
export class OWMWeather {
  ...
  constructor(obj) {
    ...
    if (obj.hasOwnProperty('sys')) {
      this.sys = new Sys(obj['sys']);
    }
    if (obj.hasOwnProperty('rain')) {
      this.rain = new Rain(obj['rain']);
    }
    if (obj.hasOwnProperty('snow')) {
      this.snow = new Snow(obj['snow']);
    }
    if (obj.hasOwnProperty('clouds')) {
      this.clouds = new Cloud(obj['clouds']);
    }
    if (obj.hasOwnProperty('wind')) {
      this.wind = new Wind(obj['wind']);
    }
    if (obj.hasOwnProperty('main')) {
      this.main = new Main(obj['main']);
    }
    if (obj.hasOwnProperty('coord')) {
      this.coord = new Coord(obj['coord']);
    }
